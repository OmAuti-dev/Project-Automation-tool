...
import { Header, HeroParallax } from "@/components/global/connect-parallax";
...
export default function Home() {
  return (
    <main>
     ...
     {/* <div className="md:mt-[18rem] mt-[-100px] justify-center items-center">
     <HCard/>
     </div> */}
